...
export default function DashboardPage() {
  ...
  // Chart Data
  const statusData = [
    { name: "To Do", value: tasks.filter((t) => t.status === "assigned").length, color: "hsl(var(--chart-1))" },
    { name: "In Progress", value: inProgressTasks, color: "hsl(var(--chart-2))" },
    { name: "Done", value: completedTasks, color: "hsl(var(--chart-3))" },
    { name: "On Hold", value: tasks.filter((t) => t.status === "on_hold").length, color: "hsl(var(--chart-4))" },
  ];

  const priorityData = [
    { name: "High", value: tasks.filter((t) => t.priority === "high").length, fill: "hsl(var(--destructive))" },
    { name: "Medium", value: tasks.filter((t) => t.priority === "medium").length, fill: "hsl(var(--chart-5))" },
    { name: "Low", value: tasks.filter((t) => t.priority === "low").length, fill: "hsl(var(--chart-1))" },
  ];
